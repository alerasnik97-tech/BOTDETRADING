...
DEFAULT_OFFICIAL_ANCHOR_FILE = DATA_VAULT / "data" / "official_anchors" / "out" / "canonical_anchor_events.csv"
DEFAULT_LEGACY_VALIDATED_FILE = DATA_VAULT / "data" / "news_eurusd_v2_utc.csv"
DEFAULT_CURATED_SUPPLEMENT_FILE = DATA_VAULT / "data" / "official_anchors" / "manifests" / "curated_supplementary_us.json"
DEFAULT_OUTPUT_FILE = DATA_VAULT / "data" / "news_eurusd_am_fortress_v3.csv"
