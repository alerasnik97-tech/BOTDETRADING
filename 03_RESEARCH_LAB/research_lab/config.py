...
DEFAULT_TRADING_ECONOMICS_IMPORT_DIR = Path("05_MARKET_DATA_VAULT/data") / "news_imports"
...
PAIR_CANONICAL_NEWS_FILES: dict[str, Path] = {
    "EURUSD": Path("05_MARKET_DATA_VAULT/data") / "news_eurusd_am_fortress_v3.csv",
    "USDJPY": Path("05_MARKET_DATA_VAULT/data") / "news_usdjpy_fortress_v1.csv",
}

PAIR_CANONICAL_NEWS_SUMMARY_FILES: dict[str, Path] = {
    "EURUSD": Path("05_MARKET_DATA_VAULT/data") / "news_eurusd_am_fortress_v3_summary.json",
    "USDJPY": Path("05_MARKET_DATA_VAULT/data") / "news_usdjpy_fortress_v1_summary.json",
}
