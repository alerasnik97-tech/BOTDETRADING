...
DATA_VAULT = PROJECT / "05_MARKET_DATA_VAULT"
RESEARCH_LAB = PROJECT / "03_RESEARCH_LAB"

DEFAULT_OUT = DATA_VAULT / "data" / "official_anchors" / "out" / "canonical_anchor_events.csv"
DEFAULT_AUDIT = DATA_VAULT / "data" / "official_anchors" / "out" / "canonical_anchor_events_audit.csv"
DEFAULT_REPORT = RESEARCH_LAB / "reports" / "official_anchors" / "pipeline_run_report.json"
MANIFEST_PATH = DATA_VAULT / "data" / "official_anchors" / "manifests" / "user_curated_releases.json"
