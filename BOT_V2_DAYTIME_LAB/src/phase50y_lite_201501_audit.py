...
# Paths
TICK_PARQUET = r"C:\Users\alera\Desktop\Bot\BOT DE TRADING ultimo\BOT_MARKET_DATA\tick\EURUSD\monthly\EURUSD_ticks_2015_01.parquet"
...
def audit_201501():
    ...
    df_month = df_raw[df_raw['ym'] == "2015-01"].copy()
    sample = len(df_month)
    print(f"Trades found: {sample}")
    
    if sample == 0:
        print("ERROR: No trades found for 2015-01")
        return

    print("\n--- TAREA 2: Replay 19:45 NY solo 2015-01 ---")
    ...
    df_replay.to_csv(os.path.join(REPORT_DIR, "PHASE50Y_LITE_201501_TRADE_LEVEL.csv"), index=False)
    ...
    with open(os.path.join(REPORT_DIR, "PHASE50Y_LITE_201501_METRICS.json"), "w") as f:
    ...
    if pf > 1.10 and exp > 0:
        ...
        with open(os.path.join(REPORT_DIR, "PHASE50Y_LITE_201501_STRESS.json"), "w") as f:
