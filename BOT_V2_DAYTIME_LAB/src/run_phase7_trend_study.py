...
def run_trend_study():
    print("Starting Phase 7 Trend Alignment Study (Fase 7)...")
    ...
    # Tests
    configs = [
        {'name': 'No Trend Filter', 'trend_filter': False},
        {'name': 'With H1 Trend Filter', 'trend_filter': True}
    ]
    ...
    pd.DataFrame(results).to_csv(output_dir / "trend_refinement_results.csv", index=False)
    print("Trend Study Complete.")
