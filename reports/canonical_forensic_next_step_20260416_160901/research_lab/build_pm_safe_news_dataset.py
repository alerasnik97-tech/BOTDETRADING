...
OUTPUT_FILE = Path("data") / "news_eurusd_pm_research_safe.csv"
OUTPUT_AUDIT_FILE = Path("data") / "news_eurusd_pm_research_safe_audit.csv"
OUTPUT_SUMMARY_FILE = Path("data") / "news_eurusd_pm_research_safe_summary.json"
