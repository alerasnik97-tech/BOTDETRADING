...
DEFAULT_USD_SOURCE_FILE = PROJECT_ROOT / "data" / "news_eurusd_am_fortress_v3.csv"
DEFAULT_JPY_RAW_FILE = PROJECT_ROOT / "data" / "forex_factory_cache.csv"
DEFAULT_OUTPUT_FILE = PROJECT_ROOT / "data" / "news_usdjpy_fortress_v1.csv"
