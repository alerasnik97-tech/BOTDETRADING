...
def signal(frame: pd.DataFrame, i: int, params: dict) -> dict | None:
    ...
    # Contexto macroscópico ADX (momentum > 25 indica tendencia fuerte presente)
    h1_adx_i = float(frame["h1_adx14"].iat[i])
    if h1_adx_i < 25.0:
        return None # No hay momentum macro, peligro de chop / retest falso. Abortamos
    ...
    for j in range(i - expiry, i):
        ...
        # Breakout LONG respect to M5 EMA + HTF ADX active
        ...
        # Breakout SHORT respect to M5 EMA + HTF ADX active
