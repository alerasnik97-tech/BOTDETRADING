...
CANONICAL_FILES: list[tuple[str, str]] = [
    ...
    ("fast_signal_execution_dashboard.md", "Resumen operativo compacto del cierre manual-edge y colapso de discriminantes de ETAPA 1."),
    ("CODEX_LOCAL_SAFETY_PROTOCOL.md", "Protocolo local de seguridad y fail-closed para futuras corridas dentro del proyecto."),
    ("CODEX_PRE_FLIGHT_CHECKLIST.md", "Checklist reutilizable para validar el perimetro y el workflow antes de ejecutar cambios."),
    ("CODEX_EXECUTION_LOG_TEMPLATE.md", "Plantilla austera para trazabilidad futura de corridas locales."),
    ("scripts/preflight_project_boundary_check.py", "Preflight reutilizable para validar que todos los paths queden dentro del root canonico."),
    ("scripts/build_chatgpt_bundle.py", "Builder canonico endurecido para reconstruir desde cero el zip unico."),
    ("ZIP_CONTENTS_MANIFEST.md", "Inventario exacto del zip canonico con motivo de inclusion por archivo."),
