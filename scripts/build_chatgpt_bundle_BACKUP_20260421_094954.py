...
ROOT_DOCS = [
    ...
    "EURUSD_MANUAL_FAST_SIGNAL_PRELIMINARY_DECISION.md",
...
def _collect_static_files() -> list[Path]:
    relative_paths = ROOT_DOCS + MANUAL_EDGE_FILES + LAB_STATE_FILES + STRATEGY_FILES + TEST_FILES + DATA_FILES + TOOLING_FILES
...
def _manifest_text(context: BundleContext, bundle_files: list[Path]) -> str:
    ...
    for path in bundle_files:
        ...
        elif relative in MANUAL_EDGE_FILES:
            sections["Manual Edge Artifacts"].append(relative)
