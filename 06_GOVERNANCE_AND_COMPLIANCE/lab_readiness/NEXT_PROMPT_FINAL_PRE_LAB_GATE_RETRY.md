# PROMPT: FINAL PRE-LAB GATE RETRY (POST-REMEDIACIÓN V3)

Actuá como Codex GPT-5.5 Max en modo Institutional Lab Readiness Officer.

OBJETIVO: Ejecutar el `FINAL_PRE_LAB_GATE` sobre la rama canónica `governance/engine-base-preflight-fix-v3-20260516`.
