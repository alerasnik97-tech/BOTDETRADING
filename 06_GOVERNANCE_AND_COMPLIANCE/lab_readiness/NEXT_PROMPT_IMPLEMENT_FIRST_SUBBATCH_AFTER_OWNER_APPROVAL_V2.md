...
If the owner has explicitly reviewed and approved the technical specifications report for the first batch strategies, you are authorized to begin **Phase 2 (targeted unit/contract tests and strategy code skeletons)** strictly for **Sub-Batch 1A**:
...
*   **Scope:** Strategy code skeletons creation and targeted unit tests implementation. **NO micro-run, NO backtesting, NO validation unsealing, NO holdout exposure**.
...
### Step 2: STOP & Handoff
*   Once the Sub-Batch 1A strategy skeletons are written and the targeted unit/contract tests pass cleanly, **STOP**.
