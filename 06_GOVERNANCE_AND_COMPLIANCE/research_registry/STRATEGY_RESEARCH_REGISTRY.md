...
| **BO01** | London Breakout | v1.0 | `MICRO_RUN_PROTOCOL_DESIGN_PENDING` | London-session breakout of the Asian range (00:00-06:30 GMT) on M5 bars. | `research/microrun-protocol-design-v1-20260517` | `9d9ab4e83f8a2449597d4477410aa991f11a7ac8` | `NOT_RUN` | `LOCKED` | `SEALED` | `SUBBATCH_1A_BO01_MR02_MICRORUN_PROTOCOL_DESIGN_V1.md` | `SKELETON_PLUS_TESTS_NO_EDGE_NO_PERFORMANCE` | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | No micro-run, no dry-run, no backtest, no formal train, no validation, no holdout, no 2025/2026, no optimization/sweep, no Sub-Batch 1B, no parallel writers | External read-only audit of micro-run protocol design (design only; no execution; no micro-run; no dry-run; no backtest; no train; no validation; no holdout; no 2025/2026; no optimization/sweep; requires external audit before any execution) | May 17, 2026 |
| **MR02** | London Fakeout Reversion | v1.0 | `MICRO_RUN_PROTOCOL_DESIGN_PENDING` | Mean-reversion fakeout of the Asian range (00:00-06:30 GMT) on M5 with engulfing confirmation. | `research/microrun-protocol-design-v1-20260517` | `9d9ab4e83f8a2449597d4477410aa991f11a7ac8` | `NOT_RUN` | `LOCKED` | `SEALED` | `SUBBATCH_1A_BO01_MR02_MICRORUN_PROTOCOL_DESIGN_V1.md` | `SKELETON_PLUS_TESTS_NO_EDGE_NO_PERFORMANCE` | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | No micro-run, no dry-run, no backtest, no formal train, no validation, no holdout, no 2025/2026, no optimization/sweep, no Sub-Batch 1B, no parallel writers | External read-only audit of micro-run protocol design (design only; no execution; no micro-run; no dry-run; no backtest; no train; no validation; no holdout; no 2025/2026; no optimization/sweep; requires external audit before any execution) | May 17, 2026 |
...
| current_state | `MICRO_RUN_PROTOCOL_DESIGN_PENDING` | `MICRO_RUN_PROTOCOL_DESIGN_PENDING` |
| branch | `research/microrun-protocol-design-v1-20260517` | same |
| commit | `9d9ab4e83f8a2449597d4477410aa991f11a7ac8` | same |
| evidence_artifact | `SUBBATCH_1A_BO01_MR02_MICRORUN_PROTOCOL_DESIGN_V1.md` | same |
| allowed_next_action | External read-only audit of micro-run protocol design (design only; no execution; no micro-run; no dry-run; no backtest; no train; no validation; no holdout; no 2025/2026; no optimization/sweep; requires external audit before any execution) | same |
