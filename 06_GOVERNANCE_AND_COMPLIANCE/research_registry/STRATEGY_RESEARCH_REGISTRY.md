...
| **BO01** | London Breakout | v1.0 | `M1_TRAIN_ONLY_EXECUTION_PROMPT_DRAFT_PENDING_AUDIT` | London-session breakout of the Asian range (00:00-06:30 GMT) on M5 bars. | `research/draft-m1-train-only-execution-prompt-v1-20260518` | `7272b8513ab4cf78cbd94ecf0f71e2a41a42658b` | `NOT_RUN` | `LOCKED` | `SEALED` | `M1_TRAIN_ONLY_EXECUTION_PROMPT_DRAFT_REPORT_V1.md` | `SKELETON_PLUS_TESTS_M0_SYNTHETIC_PASS_WITH_WARNINGS_NO_EDGE_NO_PERFORMANCE` | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | No execution, no backtest, no formal train, no validation, no holdout, no 2025/2026, no optimization/sweep, no Sub-Batch 1B, no parallel writers, no edge/performance claims | External read-only audit of M1 execution prompt draft (design only; no execution; no backtest; no train; no validation; no holdout; no 2025/2026; no optimization/sweep; external audit required before any execution) | May 18, 2026 |
| **MR02** | London Fakeout Reversion | v1.0 | `M1_TRAIN_ONLY_EXECUTION_PROMPT_DRAFT_PENDING_AUDIT` | Mean-reversion fakeout of the Asian range (00:00-06:30 GMT) on M5 with engulfing confirmation. | `research/draft-m1-train-only-execution-prompt-v1-20260518` | `7272b8513ab4cf78cbd94ecf0f71e2a41a42658b` | `NOT_RUN` | `LOCKED` | `SEALED` | `M1_TRAIN_ONLY_EXECUTION_PROMPT_DRAFT_REPORT_V1.md` | `SKELETON_PLUS_TESTS_M0_SYNTHETIC_PASS_WITH_WARNINGS_NO_EDGE_NO_PERFORMANCE` | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | No execution, no backtest, no formal train, no validation, no holdout, no 2025/2026, no optimization/sweep, no Sub-Batch 1B, no parallel writers, no edge/performance claims | External read-only audit of M1 execution prompt draft (design only; no execution; no backtest; no train; no validation; no holdout; no 2025/2026; no optimization/sweep; external audit required before any execution) | May 18, 2026 |
...
| current_state | `M1_TRAIN_ONLY_EXECUTION_PROMPT_DRAFT_PENDING_AUDIT` | `M1_TRAIN_ONLY_EXECUTION_PROMPT_DRAFT_PENDING_AUDIT` |
| branch | `research/draft-m1-train-only-execution-prompt-v1-20260518` | same |
| commit | `7272b8513ab4cf78cbd94ecf0f71e2a41a42658b` | same |
| evidence_artifact | `M1_TRAIN_ONLY_EXECUTION_PROMPT_DRAFT_REPORT_V1.md` | same |
| allowed_next_action | External read-only audit of M1 execution prompt draft (design only; no execution; no backtest; no train; no validation; no holdout; no 2025/2026; no optimization/sweep; external audit required before any execution) | same |
