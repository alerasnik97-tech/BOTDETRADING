...
| **BO01** | London Breakout | v1.0 | `M1_TRAIN_ONLY_PROTOCOL_DESIGN_PENDING_AUDIT` | London-session breakout of the Asian range (00:00-06:30 GMT) on M5 bars. | `research/m1-train-only-protocol-design-v1-20260518` | `BRANCH_HEAD` | `NOT_RUN` | `LOCKED` | `SEALED` | `M1_TRAIN_ONLY_PROTOCOL_DESIGN_REPORT_V1.md` | `SKELETON_PLUS_TESTS_M0_SYNTHETIC_PASS_WITH_WARNINGS_NO_EDGE_NO_PERFORMANCE` | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | No execution, no backtest, no formal train, no validation, no holdout, no 2025/2026, no optimization/sweep, no Sub-Batch 1B, no parallel writers, no edge/performance claims | External read-only audit of M1 train-only protocol design (design only; no execution; no backtest; no train; no validation; no holdout; no 2025/2026; no optimization/sweep; external audit required before any execution prompt) | May 18, 2026 |
| **MR02** | London Fakeout Reversion | v1.0 | `M1_TRAIN_ONLY_PROTOCOL_DESIGN_PENDING_AUDIT` | Mean-reversion fakeout of the Asian range (00:00-06:30 GMT) on M5 with engulfing confirmation. | `research/m1-train-only-protocol-design-v1-20260518` | `BRANCH_HEAD` | `NOT_RUN` | `LOCKED` | `SEALED` | `M1_TRAIN_ONLY_PROTOCOL_DESIGN_REPORT_V1.md` | `SKELETON_PLUS_TESTS_M0_SYNTHETIC_PASS_WITH_WARNINGS_NO_EDGE_NO_PERFORMANCE` | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | No execution, no backtest, no formal train, no validation, no holdout, no 2025/2026, no optimization/sweep, no Sub-Batch 1B, no parallel writers, no edge/performance claims | External read-only audit of M1 train-only protocol design (design only; no execution; no backtest; no train; no validation; no holdout; no 2025/2026; no optimization/sweep; external audit required before any execution prompt) | May 18, 2026 |
